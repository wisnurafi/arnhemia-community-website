      ...
      <div className="container flex min-h-screen items-center justify-center py-16">
        <div className="w-full max-w-md">
          <div className="text-center">
            ...
            <div className="mx-auto mt-8 h-8 w-56 animate-pulse rounded bg-white/[0.06]" />
            <div className="mx-auto mt-2 h-4 w-64 animate-pulse rounded bg-white/[0.06]" />
          </div>
          ...
          <div className="mx-auto mt-6 h-4 w-44 animate-pulse rounded bg-white/[0.06]" />
        </div>
      </div>
    </main>
  );
